...
import { BiometricPoint, UserRole, TestDefinition } from '../App';
...
export const IdentityCore: React.FC<IdentityCoreProps> = ({ role, onLogout, onStartEvaluation, onNexus, data, isAnalyzed, catalog }) => {
