      ...
      <div className="bg-white/[0.03] border border-white/10 rounded-[40px] p-8 space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h4 className="text-sm font-black uppercase tracking-widest">Potencial de Crecimiento</h4>
          </div>
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-center">
            <span className="text-xs text-white/40 font-bold uppercase tracking-widest">Sincronía de Red</span>
